...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23/11/2024 às 03:59
...
(1, '2024-12-25', 1, '02:22:00', '00:22:00', 3, 'concluido', '23:22:18');
...
--
-- Despejando dados para a tabela `ag_prod_cliente`
--

INSERT INTO `ag_prod_cliente` (`id_agprodcliente`, `id_produto`, `id_usuario`, `id_agendamento`, `hora_inicio`, `hora_fim`, `endereco`) VALUES
(1, 1, 3, 1, '03:22:00', '16:22:00', 'asd,asd,asd,asd');
...
(9, 'negan', 'edu@gmail.com', '1289371', 'asndasu', 'asbdahs');
...
(3, 'negan', 'edu@edu.com', '$2y$10$aizMdVzJMwwBqeJTK0oJjuPrBmymI588xg.KGFljEEoDGEwTB2BQC', NULL);
...
--
ALTER TABLE `ag_prod_cliente`
  MODIFY `id_agprodcliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
