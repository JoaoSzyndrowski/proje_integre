...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23/11/2024 às 17:21
...
(1, 'eduardo frigo', 'eduardosfrigo@gmail.com', '123123', NULL, '123123'),
(2, 'negan', 'negan@gmail.com', '123', NULL, '123');
...
(1, 'eduardo frigo', 'eduardosfrigo@gmail.com', '$2y$10$8pkPpnniInOOZ4iiJXQmm.stUmzXrp9bawVPw2gZFu0YtvaYL8Gxm', NULL),
(2, 'negan', 'negan@gmail.com', '$2y$10$ohPQj9cQHnMZwp6IoWt8qOPjQ4ToC8Y7XXf9QVaSlfN4JlTmvXhLK', NULL);
...
--
ALTER TABLE `ag_prod_cliente`
  MODIFY `id_agprodcliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `ag_prod_cliente`
  ...
  ADD CONSTRAINT `fk_produto` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`) ON DELETE CASCADE ON UPDATE CASCADE,
